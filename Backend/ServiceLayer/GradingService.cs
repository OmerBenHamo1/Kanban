...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            StartService ss = new ();
            us = ss.GetUserService;
            ts = ss.GetTaskService;
            bs = ss.GetBoardService;
        }
        ...
        public string Login(string email, string password)
        {
            ...
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(email, null));
        }
        ...
        {
            string json = bs.LimitColumn(email, boardName, columnOrdinal, limit);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
        ...
        {
            string json = ts.AddTask(email, boardName, title, description, dueDate);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = ts.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = ts.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = ts.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = ts.AdvanceTask(email, boardName, columnOrdinal, taskId);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = bs.CreateBoard(email, name);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        {
            string json = bs.DeleteBoard(email, name);
            var response = JsonSerializer.Deserialize<Response>(json);
            if (response.ErrorMessage != null)
                return json;
            return JsonSerializer.Serialize(new Response(null, null));
        ...
        /// <summary>
        /// This method returns a list of board IDs of all user's boards.
        /// </summary>
        /// <param name="email">Email of the user. Must be logged in</param>
        ...
        {
            return ts.TransferOwnership(currentOwnerEmail, newOwnerEmail, boardName);
        }
